 ...
 * facilitating targeted improvements in athletic performance.</p>
 *
 * <p>
...
public class MainForm extends javax.swing.JFrame {
    ...
    /**
     * <p>
     * MainForm constructor method with its settings</p>
     */
    public MainForm() {
        initComponents();
        setSize(1000, 600);
    ...
    /**
     * <p>
     * This method creates a new PnlWelcome with its default settings. After its
     * creation, it is added to the frame.</p>
     */
    ...
    /**
     * <p>
     * This method validates the Login credentials provided by users when login
     * into the app.</p>
     */
    ...
    /**
     * <p>
     * This method validates the Login credentials provided by users.</p>
     *
    ...
    /**
     * <p>
     * This method updates the score and comments provided by the
     * instructor.</p>
     *
     ...
     * it displays a message with the result.</p>
     *
    ...
    /**
     * <p>
     * This method gets a list with all users and their information.</p>
     *
    ...
    /**
     * <p>
     * This method gets a list with all the attempts for a specific user.</p>
     *
    ...
    /**
     * <p>
     * This method gets a review by its attempt identification.</p>
     *
     ...
     * This method gets a review by its attempt identification.</p>
     *
     * @param u User for which we want to get the information from.
     * @return ArrayList of activities for the specific user.
     */
    ...
    /**
     * <p>
     * This method returns an ArrayList of activities pending to be reviewed for
     * a specific user.</p>
     *
     * @param u User for which we want to get the information from.
     * @return ArrayList of activities for the specific user.
    ...
    /**
     * <p>
     * This method changes the appearance from Light to Dark and vice-versa.</p>
     *
     * @param isEnabled boolean to switch between Enabled or Disabled the toggle
     * button.
     * @throws javax.swing.UnsupportedLookAndFeelException This method throws an
     * unsupported exception.
     */
    public void changeLookAndFeel(boolean isEnabled) throws UnsupportedLookAndFeelException {

        //If isEnabled equals true, set the Look and Feel to Dark Theme
        if (isEnabled) {
            UIManager.setLookAndFeel(new FlatArcDarkIJTheme());
            FlatDarkLaf.registerCustomDefaultsSource("style"); //Properties
            FlatDarkLaf.setup();

            //If isEnabled equals false, set the Look and Feel to Light Theme
        } else {
