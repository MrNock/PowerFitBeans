 ...
 * @since 1.5
 */
public class PnlActivities extends javax.swing.JPanel implements MyEventSwipeListener, MyEventPlayVideoListener {
    ...
    /**
     * <p>
     * Creates a new form PnlIntentos.</p>
     *
    ...
    /**
     * <p>
     * This method adds the activities into the container.</p>
     *
    ...
    /**
     * <p>
     * This method is used to play the first video when loading the app.</p>
     */
    ...
    /**
     * <p>
     * This method handles the video player when clicking the JButton component.
     * It resumes and pauses the video when clicked.</p>
     */
    ...
    /**
     * <p>
     * This method instantiates the showWelcomePanel method after clicking the
     * Logout icon.</p>
     */
    ...
    /**
     * <p>
     * This method instantiates the swipeInfo method to set the direction after
     * the swipe event.</p>
     */
    @Override
    ...
    /**
     * <p>
     * This method instantiates the getVideoFile method to get the video
     * file.</p>
     */
    @Override
    public void miEventoPlayVideoActionPerformed(MyEventPlayVideo evt) {
